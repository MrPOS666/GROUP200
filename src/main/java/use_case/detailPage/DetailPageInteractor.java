...
public class DetailPageInteractor implements DetailPageInputBoundary {
    ...
    public void execute(DetailPageInputData detailPageInputData) {
        ...
        final DetailPageOutputData outputData = new DetailPageOutputData(false,
                username, cocktailName, cocktailID, instruction,
                photolink, ingredients, image, previousViewName);
    ...
    public void addMyFavourite(DetailPageInputData detailPageInputData) {
        try {
            ...
            final Cocktail newCocktail = cocktailFactory.create(detailPageInputData.getCocktailID(),
                    detailPageInputData.getCocktailName(), detailPageInputData.getInstruction(),
                    detailPageInputData.getPhotolink(), detailPageInputData.getIngredients(),
            ...
            if (!cocktailExists) {
                ...
                final DetailPageOutputData outputData = new DetailPageOutputData(false,
                        detailPageInputData.getUsername(), detailPageInputData.getCocktailName(),
                        detailPageInputData.getCocktailID(), detailPageInputData.getInstruction(),
                        detailPageInputData.getPhotolink(), detailPageInputData.getIngredients(),
                        detailPageInputData.getImage(), detailPageInputData.getPreviousViewName());
